...
//        self.addConstraints([w, h])
    ...
    func shouldEnable(_ enable : Bool) {
        ...
        self.backgroundColor = enable ? #colorLiteral(red: 0.4980392157, green: 0.7215686275, blue: 0, alpha: 1) : #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
